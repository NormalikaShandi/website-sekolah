 ...
 <div class="container">
        ...
        <p class="about-sub-title">Program Studi di SMA Al-Muttaqien.</p>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".7s">
                <div class="service-box2">
                    <div class="service-box-icon">
                        <a href="#"><i class="fa fa-book" aria-hidden="true"></i></a>
                    </div>
